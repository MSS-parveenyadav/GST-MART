<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/ReportViewers/Reports.Master" AutoEventWireup="true" CodeBehind="14-TV_Goods_Imported.aspx.cs" Inherits="Gst_RPT.ReportViewers._14_TV_Goods_Imported" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_For_RptLable" runat="server">
    14 – Total Value of goods imported
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="CPH_For_ForReport" runat="server">
    <rsweb:ReportViewer ID="rpvGoodimported" Height="800px" Width="100%" runat="server"></rsweb:ReportViewer>
