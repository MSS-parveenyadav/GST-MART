...
namespace Gst_RPT.ReportViewers
{
    public partial class WebForm3 : System.Web.UI.Page
    {
        string query = @"SELECT Customer_Name ,Customer_BRN ,
                        ...
                        FROM GAF_SUPPLY WHERE Tax_Code in (SELECT Taxcode FROM dbo.ufnGetTaxCodeByItem('11')) ";
        ...
        private void BindReport(string query)
        {
            ...
            rptViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Reports/rptTVO_ExportSales.rdlc");
            ReportDataSource datasource = new ReportDataSource("field11ds", ds.Tables[0]);
