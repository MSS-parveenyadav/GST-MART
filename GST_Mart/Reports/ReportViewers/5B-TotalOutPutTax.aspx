<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/ReportViewers/Reports.Master" AutoEventWireup="true" CodeBehind="5B-TotalOutputTax.aspx.cs" Inherits="Gst_RPT.ReportViewers._5B_TotalOutputTax" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="CPH_For_ForReport" runat="server">
    <rsweb:ReportViewer ID="rpvTotaloutputtax" runat="server" Height="800px" Width="100%"></rsweb:ReportViewer>
