...
namespace Gst_RPT.ReportViewers
{
    public partial class WebForm1 : System.Web.UI.Page
    {
            string query = @"SELECT Customer_Name ,Customer_BRN ,
                            ...
                            FROM GAF_SUPPLY WHERE Tax_Code in (SELECT Taxcode FROM dbo.ufnGetTaxCodeByItem('12'))";
            ...
            private void BindReport(string query)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    rptViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Reports/rptTVO_exempt_supplies.rdlc");
                    ReportDataSource datasource = new ReportDataSource("field12ds", ds.Tables[0]);
