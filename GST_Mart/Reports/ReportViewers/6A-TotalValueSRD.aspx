<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/ReportViewers/Reports.Master" AutoEventWireup="true" CodeBehind="6A-TotalValueSRD.aspx.cs" Inherits="Gst_RPT.ReportViewers._6A_TotalValueSRD" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPH_For_RptLable" runat="server">
    6a – Total Value of Standard Rated Acquisition
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="CPH_For_ForReport" runat="server">
    <rsweb:ReportViewer ID="rpvTotalvalueSRD" Height="800px" Width="100%" runat="server"></rsweb:ReportViewer>
