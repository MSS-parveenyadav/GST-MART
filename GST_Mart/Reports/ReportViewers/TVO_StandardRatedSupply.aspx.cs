...
namespace Gst_RPT.ReportViewers
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        string query = @"SELECT Customer_Name,Customer_BRN ,
                         ...
                         FROM GAF_SUPPLY WHERE Tax_Code in (SELECT Taxcode FROM dbo.ufnGetTaxCodeByItem('10'))";
        ...
        private void BindReport(string query)
        {
            ...
            rptViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Reports/rptTVO_StandardRatedSupply.rdlc");
            ReportDataSource datasource = new ReportDataSource("field10ds", ds.Tables[0]);
